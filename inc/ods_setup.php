...
class odsSetup
{
	...
	*/
	public function setup()
	{
		...
		*/
		add_editor_style( array( 'css/editor-style.css', $this->add_editor_font() ) );
	...
	public function enqueue_scripts()
	{
		...
		*/
		...
		wp_enqueue_style(
			...
			array(),
			filemtime( dirname( dirname( __FILE__ ) ) . '/style.css' )
		);
		...
		*/
		...
		wp_enqueue_script( 'global', get_template_directory_uri() . '/js/global.js', array( 'jquery', 'json2' ), false, true );
